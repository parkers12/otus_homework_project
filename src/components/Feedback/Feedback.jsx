    ...
    <div className="feedback">
      <div className="feedback__wrapper">
        <div className="feedback__header">
          <div className="title title_feedback">
            Отзывы <span>покупателей</span>
          </div>
          ...
          <div className="feedback__body-block">
            ...
            <div className="feedback__body-block-text">
              ...
              <div className="feedback__body-block-text-comment">
                Ассортимент изделий из жемчуга, по -моему мнению, самый большой
                в Москве. Единственное, этот магазин специализируется только на
                жемчуге (пресноводный, морской). Хорошие девушки-консультанты.
                Оплатить можно и картой и наличными. Выбрала бусы из
                пресноводного жемчуга. Ношу с удовольствием.
              </div>
            </div>
          </div>
